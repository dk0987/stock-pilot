...
SET @admin_id = 'a0e9b8c7-d6f5-e4d3-c2b1-100000000001';
SET @inventory_manager_id = 'a0e9b8c7-d6f5-e4d3-c2b1-100000000002';
SET @sales_manager_id = 'a0e9b8c7-d6f5-e4d3-c2b1-100000000003';
SET @viewer_id = 'a0e9b8c7-d6f5-e4d3-c2b1-100000000004';
SET @approver_id = 'a0e9b8c7-d6f5-e4d3-c2b1-100000000005';

-- Placeholder for a securely hashed password
SET @hashed_password = '{bcrypt}$2a$10$3g.a.z9A2B3cDef4G5H6i.jK7lM8nO9pQrStUvWxYz012';
...
(UUID(), 'sys_alice', 'alice.adams@corp.com', @hashed_password, 'Alice', 'Adams', '555-0101', TRUE, '2022-01-10', '2024-09-01', @admin_id),
